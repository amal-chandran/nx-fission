...
export type createHttpMutationVariables = Exact<{
  object: V1HTTPTriggerInput;
}>;


export type createHttpMutation = { createHttps?: Maybe<Pick<V1ObjectMeta, 'name'>> };
...
export type deleteHttpMutation = Pick<Mutation, 'deleteHttp'>;
...
export const createHttpDocument = gql`
    mutation createHttp($object: V1HTTPTriggerInput!) {
  createHttps(v1HTTPTriggerInput: $object) {
    name
  }
}
    ` as unknown as DocumentNode<createHttpMutation, createHttpMutationVariables>;
export const deleteHttpDocument = gql`
    mutation deleteHttp($httpTrigger: String!) {
  deleteHttp(httpTrigger: $httpTrigger)
}
    ` as unknown as DocumentNode<deleteHttpMutation, deleteHttpMutationVariables>;
...
export function getSdk<C>(requester: Requester<C>) {
  return {
    ...
    createHttp(variables: createHttpMutationVariables, options?: C): Promise<createHttpMutation> {
      return requester<createHttpMutation, createHttpMutationVariables>(createHttpDocument, variables, options);
    },
    deleteHttp(variables: deleteHttpMutationVariables, options?: C): Promise<deleteHttpMutation> {
      return requester<deleteHttpMutation, deleteHttpMutationVariables>(deleteHttpDocument, variables, options);
    },
